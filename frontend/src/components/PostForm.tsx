...
import { CircleAlert, Vote, Pencil } from "lucide-react";
import { getAllPosts } from "../utils/hooks/actions";

export default function PostForm({ account }: { account: Address }) {
  ...
  const [posts, setPosts] = useState<PostDetails[] | any>([]);
            ...
            <div className={styles.bottomPrimary}>
              <div className={styles.secondary}>
                <label htmlFor="spoiler">
                  ...
                  >
                    <CircleAlert
                      className={`${!post.spoil ? "#359AECff" : "#FF5D64ff"}`}
                    />
                    Spoiler
                  </button>
                </label>
                <label htmlFor="hasPoll">
                  ...
                  >
                    <Vote
                      className={`${!pollElementVisible ? "#359AECff" : "#FF5D64ff"}`}
                    />
                ...
                <button type="submit" className={styles.submit}>
                  <Pencil
                    className={`${isPostSubmitting ? "#359AECff" : "#FF5D64ff"}`}
                  />
